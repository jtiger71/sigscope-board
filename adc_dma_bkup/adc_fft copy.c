...
int main22() {                                                                         // start of main  00000
     srand(time(NULL));

//******************************************************************************************************
// Needs following varaible array size modification.
//******************************************************************************************************
...
*/ 
        ...
        // Finding the start point of data to be displayed
          ...
          if(READABLE_DISPLAY_FLAG) {
               ...
               // // HEAD
               // displaysize++;
               // printf("{{=>"); write(STDOUT_FILENO, &displaysize, sizeof(displaysize)); printf("}}");
               // // DATA
               // for (int xx = 0; xx < displaysize; xx++) {  
               //      write(STDOUT_FILENO, &cap_buf[xx], sizeof(cap_buf[xx]));
               // }

               int lengthCh1 = 0, lengthCh2 = 0;
               short *dataCh1 = genSample(&lengthCh1);
               short *dataCh2 = genSample(&lengthCh2);

               sendData(1, dataCh1, lengthCh1);
               sendData(2, dataCh2, lengthCh2);
